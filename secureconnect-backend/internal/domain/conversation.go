...
type Conversation struct {
	...
	Title          string    `json:"title" db:"title"`         // Conversation title
...
// ConversationParticipantDetail represents a user in a conversation with user details
type ConversationParticipantDetail struct {
